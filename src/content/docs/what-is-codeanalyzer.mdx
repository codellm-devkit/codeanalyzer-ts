...
<CardGrid>
  <LinkCard title="Quickstart" description="Build the CLI and produce your first analysis.json." href="/codeanalyzer-ts/quickstart/" />
  <LinkCard title="Core concepts" description="Symbol table, call graph, external symbols, signatures, provenance, caching." href="/codeanalyzer-ts/guides/concepts/" />
  <LinkCard title="CLI usage" description="Every flag with worked examples." href="/codeanalyzer-ts/guides/cli-usage/" />
  <LinkCard title="Output schema" description="The TSApplication data model in full." href="/codeanalyzer-ts/reference/schema/" />
</CardGrid>
