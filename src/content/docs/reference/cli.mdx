...
Both encode the same `TSApplication` schema — see [Output schema](/codeanalyzer-ts/reference/schema/).
...
<CardGrid>
  <LinkCard title="CLI usage" description="Worked examples and the reasoning behind each flag." href="/codeanalyzer-ts/guides/cli-usage/" />
  <LinkCard title="Output schema" description="The TSApplication artifact, field by field." href="/codeanalyzer-ts/reference/schema/" />
</CardGrid>
