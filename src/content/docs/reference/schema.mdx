...
<Aside type="note">
Edge endpoints not present in the symbol table (imported-library / Node builtin targets) are kept as phantom [external symbols](#tsexternalsymbol) rather than dropped. See [Call graph & dispatch](/codeanalyzer-ts/guides/call-graph/#phantom-nodes).
</Aside>
...
<CardGrid>
  <LinkCard title="Core concepts" description="How these models relate at runtime." href="/codeanalyzer-ts/guides/concepts/" />
  <LinkCard title="Call graph & dispatch" description="How TSCallEdge and TSExternalSymbol are produced." href="/codeanalyzer-ts/guides/call-graph/" />
  <LinkCard title="CLI options" description="The flags that control what ends up in the artifact." href="/codeanalyzer-ts/reference/cli/" />
</CardGrid>
